...
export const ANALYSIS_SLIDES: Slide[] = [
  ...
  },
  {
    ...
    bullets: [
      "SUMMARY:<strong>진단 목적</strong>|AI 플랫폼(ChatGPT, Perplexity, Gemini 등)에서<br> A사가 얼마나 올바르게 인식·인용되는지 측정",
      "SUMMARY:<strong>개선 범위</strong>|메인페이지 + 제품 상세페이지<br/>(코드 수정 수준)",
      "SUMMARY:<strong>수집 항목</strong>|① A사 언급 유무<br/>② 인용 URL<br/>③ 오류/누락 내용<br/>④ 제품명·스펙 정확도",
      "QUESTION:브랜드 인식|A사는 어떤 회사고, 어떤 제품을 판매하나요?",
      ...
      "QUESTION:제품 스펙|A사 제품(ID) 음식물처리기 스펙이랑 주요 기능 알려줘.",
      "MODEL:ChatGPT",
      "MODEL:Perplexity",
      "MODEL:Gemini",
      "MODEL:Claude"
  ...
  },
  {
    id: 41,
    title: "1-3. 경쟁사 언급 현황",
    oneLiner: "주요 모델 내 <strong>A사 누락 및 경쟁사 반복 노출</strong> 원인 분석",
    bullets: [],
  ...
  },
  {
    ...
    bullets: [
      ...
      "INSIGHT:사실 오류 패턴: 공식 텍스트 부재 시 AI가 '추론'으로 정보를 생성.|모델별 사실 관계 오인 발생: 특정 모델에서 제품명을 타사 모델명으로 오기하거나, 본사 주소를 타 지역으로 잘못 생성함.",
